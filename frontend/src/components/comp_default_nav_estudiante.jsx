...
class DefaultNavBarEstudiante extends Component {
                    ...
                    <div className="collapse navbar-collapse" id="navContent">
                        <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                            <li className="nav-item active">
                                <a name="" className="nav-link" href="#estudiante">Home <span className="sr-only">(current)</span></a>
                            </li>

                            <li className="nav-item">
                                <a name="comunicados" className="nav-link" href="#estudiante/comunicados">Comunicados generales </a>
                            </li>

                            <li className="nav-item">
                                <a className="nav-link" href="#estudiante/materias">Mis materias </a>
                            </li>
                        </ul>
...
export default DefaultNavBarEstudiante;